...
# stars_clip = mpy.CompositeVideoClip([mpy.ImageClip(STARS_PATH).set_position("center")], size=SCREEN_SIZE,stars = findObjects(stars_clip)
...
final_clip = (
    mpy.CompositeVideoClip([sb_logo], size=SCREEN_SIZE)
